import { IncreaseLiquidityArgs, Result_5 as IncreaseLiquidityResult } from "@/blockchain_api/did/appic/appic_dex/appic_dex_types";
...
export async function generate_args_and_approve_add_liquidty(args: AddLiquidityArgs,
	authenticated_agent: Agent, // HttpAgent , Agent
	unauthenticated_agent: HttpAgent,
): Promise<Response<IncreaseLiquidityArgs | undefined>> {
	let { increase_liquidty_args, token1_approval_amount, token0_approval_amount } = generate_increase_liquidty_args(args);
