...
import { CandidDexAction, CandidEvmToIcp, CandidIcpToEvm, CandidPositionKey, CandidSwapType, Transaction } from '@/blockchain_api/did/appic/appic_helper/appic_helper_types';
...
export const get_transaction_history = async (
	...
	try {
		if (evm_wallet_address && principal_id) {
			...
			return { result: transform_txs(txs, bridge_tokens, all_icp_tokens), message: '', success: true };
