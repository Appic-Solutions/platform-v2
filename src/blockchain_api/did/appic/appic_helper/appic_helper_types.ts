...
export interface _SERVICE {
  ...
  get_dex_actions_for_principal: ActorMethod<[Principal], Array<CandidDexAction>>;
  ...
  get_top_100_tokens_by_volume_per_chain: ActorMethod<[], Array<TopVolumeTokens>>;
  ...
  update_evm_token_price_volume: ActorMethod<[Array<[bigint, string, string]>], undefined>;
