...
export type AddEvmToIcpTxError = { 'InvalidAddress' : null } |
...
export type AddIcpToEvmTxError = { 'InvalidDestination' : null } |
  { 'ChainNotSupported' : null } |
  { 'InvalidTokenPairs' : null } |
  { 'InvalidTokenContract' : null } |
  { 'TxAlreadyExists' : null };
...
export type EvmToIcpStatus = { 'Invalid' : string } |
  ...
  { 'Accepted' : null } |
  { 'Quarantined' : null };
export interface GetEvmTokenArgs { 'chain_id' : bigint, 'address' : string }
export interface GetIcpTokenArgs { 'ledger_id' : Principal }
export interface GetTxParams {
  'chain_id' : bigint,
  'search_param' : TransactionSearchParam,
}
export type IcpToEvmStatus = { 'Failed' : null } |
  ...
  { 'Successful' : null } |
  { 'Created' : null };
export type IcpTokenType = { 'ICRC1' : null } |
  { 'ICRC2' : null } |
  { 'ICRC3' : null } |
  { 'DIP20' : null } |
  { 'Other' : string };
...
export interface InitArgs { 'minters' : Array<MinterArgs> }
export type LoggerArgs = { 'Upgrade' : UpgradeArg } |
  { 'Init' : InitArgs };
...
export type Operator = { 'AppicMinter' : null } |
  { 'DfinityCkEthMinter' : null };
...
export interface TopVolumeTokens {
  'chain' : bigint,
...
export interface _SERVICE {
  ...
  'get_erc20_twin_ls_requests_by_creator' : ActorMethod<
    [Principal],
    Array<CandidLedgerSuiteRequest>
  >,
  ...
  'get_top_100_tokens_by_volume_per_chain' : ActorMethod<
    [],
    Array<TopVolumeTokens>
  >,
  'get_transaction' : ActorMethod<[GetTxParams], [] | [Transaction]>,
  'get_txs_by_address' : ActorMethod<[string], Array<Transaction>>,
  'get_txs_by_address_principal_combination' : ActorMethod<
    [string, Principal],
    Array<Transaction>
  >,
  ...
  'new_twin_ls_request' : ActorMethod<
    [CandidAddErc20TwinLedgerSuiteRequest],
    undefined
  >,
  'request_update_bridge_pairs' : ActorMethod<[], undefined>,
  'search_evm_token' : ActorMethod<[EvmSearchQuery], Array<CandidEvmToken>>,
  'update_evm_token_price_volume' : ActorMethod<
    [Array<[bigint, string, string]>],
    undefined
  >,
  'update_twin_ls_request' : ActorMethod<
    [CandidAddErc20TwinLedgerSuiteRequest],
    undefined
  >,
}
