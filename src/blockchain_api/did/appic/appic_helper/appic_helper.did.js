export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    get_dex_actions_for_principal: IDL.Func([IDL.Principal], [IDL.Vec(CandidDexAction)], ['query']),
    ...
    get_top_100_tokens_by_volume_per_chain: IDL.Func([], [IDL.Vec(TopVolumeTokens)], ['query']),
    ...
    search_evm_token: IDL.Func([EvmSearchQuery], [IDL.Vec(CandidEvmToken)], ['query']),
