...
export type Blockchain = { 'Evm': bigint } |
{ 'ICP': null };
...
export type CandidRecipient = { 'IcPrincipal': Principal } |
{ 'EvmAddress': string };
...
export type CrosschainSwapError = { 'DepositError': DepositError } |
...
{ 'LockedPrincipal': null } |
{ 'AmountOverflow': null };
export interface MinterKey { 'id': Principal, 'chain_id': bigint }
...
{ 'InvalidFeeForExactOutput': null } |
{ 'CalculationOverflow': null };
export type SwapOrderCreationError = { 'InvalidOriginChain': null } |
{ 'InvalidAmountOut': null } |
