...
export type DexOrderError =
  | { InvalidMaxUsdFeeAmount: string }
...
export type Result = { Ok: null } | { Err: DexOrderError };
export type Result_1 = { Ok: null } | { Err: RequestScrapingError };
export type Result_2 = { Ok: RetrieveErc20Request } | { Err: WithdrawErc20Error };
export type Result_3 = { Ok: RetrieveNativeRequest } | { Err: WithdrawalError };
export type Result_4 = { Ok: RetrieveWrapIcrcRequest } | { Err: WrapIcrcError };
...
export interface _SERVICE {
  ...
  retrieve_swap_status_by_swap_tx_id: ActorMethod<[string], [] | [SwapStatus]>;
