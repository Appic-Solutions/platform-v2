...
import ActionButton from "@/components/pages/bridge/select-token/_components/ActionButton";
            ...
            <div className="text-white flex flex-col gap-y-8 md:gap-y-4">
              ...
              >
                ...
                <div className="flex flex-col gap-y-2">
                  ...
                  <div className="text-[#0A0A0B] text-sm gap-x-4 rounded-lg py-[9px] px-4 border-[1px] border-white bg-white/50 dark:bg-[#F5F5F5] flex items-center justify-between w-[160px]">
                    {format(date, "PP")}
                  </div>
                </div>
              </div>
