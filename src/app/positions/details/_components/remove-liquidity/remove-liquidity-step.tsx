...
import {
  RemoveLiquidityStepDetail,
  RemoveLiquidityStep as RemoveLiquidityStepType,
} from '@/app/positions/types';

export const RemoveLiquidityStep = ({
  currentStep,
  step,
  index,
  onResetTransaction,
}: {
  step: RemoveLiquidityStepDetail;
  currentStep: RemoveLiquidityStepType;
  index: number;
