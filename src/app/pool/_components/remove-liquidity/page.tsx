        ...
        <Box className={cn(
            ...
            <div className="flex flex-col gap-y-3 w-full">
                    ...
                    <div className={cn(
                        ...
                        <div className={cn(
                            ...
                            <Avatar
                                ...
                                src="/images/logo/icp-logo.svg"
                                className={cn(
                                    "h-[31px] w-[31px] md:h-[58px] md:w-[58px]",
                                    "-ml-4"
                                )}
                            />
                        </div>
                        <div className={cn(
                            "flex items-center",
                            "text-[27px] md:text-[32px] font-bold",
                ...
                <div className={cn(
                    ...
                    <p className="text-white/70 font-semibold md:text-xl">
                        Withdrawal amount
                    </p>
                    <div className="flex items-center justify-between w-full">
                        <p className="text-white text-[22px] md:text-[27px] font-semibold">
                            1234.55
                        </p>
                        <div className="flex items-center gap-x-2">
                            <span className={cn(
                                "bg-white/10",
                                "text-white/80 text-xs md:text-sm font-medium",
                                "px-1.5 py-1 md:px-3",
                            ...
                            <span className={cn(
                                "bg-[#2060D5]/45",
                                "text-[#A7C6FF] text-xs md:text-sm font-medium",
                                "px-1.5 py-1 md:px-3",
                                "rounded-[10px] md:rounded-[16px]"
                            )}>
                                50%
