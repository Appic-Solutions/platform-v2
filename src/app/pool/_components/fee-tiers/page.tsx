  ...
  return (
    ...
    >
      ...
      <div className={cn('relative isolate', 'flex items-center justify-between gap-4', 'w-full')}>
        ...
        <h1
          className={cn('text-[27px] font-bold md:text-[30px]', 'absolute inset-x-0 text-center')}
        >
          Fee tiers
        </h1>
      </div>
      ...
      {/* Main */}
      <div
        className={cn('overflow-y-auto', 'max-h-[550px]', 'w-full *:w-full', 'flex flex-col gap-3')}
      >
        <div
          className={cn(
            'relative isolate',
        ...
        >
          <div className="flex items-center justify-between gap-5">
            <div className="text-xl font-semibold md:text-2xl">0.01%</div>
            {selected && (
              <>
          ...
          <div className={cn('mb-6 md:mb-8', 'text-[17px] text-[#898989] md:text-xl')}>
            Best for very stable pairs.
          </div>
          <div className={cn('flex items-center justify-between gap-4', 'text-white md:text-xl')}>
            <span>$1.5test</span>
            <span>0% select</span>
          </div>
        </div>
