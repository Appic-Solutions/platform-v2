  ...
  return (
    <div className="flex items-center justify-center gap-1">
      {Array.from({ length: totalSteps }).map((_, idx: number) => {
        ...
        const isClickable =
          stepIndex < currentStep || (stepIndex === currentStep && selectedStep !== 0);
        ...
        return (
          <button
            ...
            className={cn(
              'h-1 w-6 rounded-full border-0 transition-colors',
            ...
            onClick={() => {
              if (clickHandler && isClickable)
                clickHandler(stepIndex === currentStep ? 0 : stepIndex);
            }}
