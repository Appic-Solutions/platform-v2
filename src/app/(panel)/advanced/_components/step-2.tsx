...
export default function Step2({ isLoading, newTwinMeta, prevStepHandler }: Step2Props) {
  ...
  return (
    <Box className="h-full justify-between gap-y-5 md:h-auto md:max-w-[537px]">
      ...
      <div className="flex items-center gap-4 self-start">
        <div className="relative">
          ...
          <Avatar
            ...
            className="absolute -right-1 bottom-0 h-4 w-4 shadow-[0_0_3px_0_rgba(255,255,255,0.5)]"
          />
        </div>
      ...
      <div className="flex w-full flex-col gap-y-3 rounded-xl bg-white/10 p-6 text-white">
