...
import TokenCard from '@/app/(panel)/auto-invest/_components/chain-token-list/token-card';
import { CreatePositionFormDefaultValues } from '../../schema';
import { TokenListPageProps } from '@/app/(panel)/positions/types';
  ...
  return (
    <div className="flex h-full w-full animate-fade flex-col gap-y-4 overflow-y-auto">
      ...
      <RHFInput
        ...
        className="h-10 w-full rounded-md border-[#000000] px-3 py-2"
      />
