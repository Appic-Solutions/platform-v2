...
import AvatarGroup from '@/app/(panel)/positions/_components/AvatarGroup';
  ...
  return (
    <div className="flex animate-fade flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        {/* Input */}
        <div className="group w-full rounded-[20px] bg-box-border-gradient p-0.5 text-white backdrop-blur-[30px]">
