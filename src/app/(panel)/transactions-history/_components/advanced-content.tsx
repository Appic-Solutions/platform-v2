...
export default function AdvancedContent() {
  ...
  const { data, isLoading, isError } = useQuery({
    ...
    queryFn: async () =>
      get_advanced_history(icpIdentity as Principal, unAuthenticatedAgent as HttpAgent),
      ...
      >
          ...
          <div className="flex w-full items-center justify-start gap-4">
            <div className="relative">
              ...
              <Avatar
                ...
                className="absolute -bottom-1 -right-1 h-6 w-6 shadow-[0_0_3px_0_rgba(255,255,255,0.5)]"
              />
            </div>
        ...
        <div
          ...
          className={cn(
            ...
            'cursor-pointer select-none text-xs font-semibold text-[#898989]',
          )}
        >
