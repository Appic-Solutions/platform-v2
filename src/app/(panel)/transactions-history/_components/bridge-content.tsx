    ...
    return bridgeData?.map((item, idx) => (
      ...
      >
        ...
        <div className="mb-4 flex flex-col gap-y-4">
          <div
            className={cn(
              'flex items-center justify-between gap-x-4 text-xs font-bold text-[#898989]',
        ...
        >
          {/* Transaction ID */}
          <div className="flex items-center gap-x-1 text-sm font-bold text-[#898989]">
            ...
            {item.bridge_steps.map((step, idx) => (
              <div
                ...
                className={cn(
                  ...
                  'text-sm font-semibold text-[#898989]',
                )}
              >
        ...
        <div
          className={cn(
            'flex items-center justify-between gap-x-4 text-xs text-[#898989]',
