...
export type ICRC1SubAccountBalance = { ok: bigint } | { err: string };
export type ICRCTxReceipt = { Ok: Uint8Array | number[] } | { Err: string };
...
export type TokenBlockType = { Full: boolean } | { None: boolean } | { Partial: boolean };
...
export type ValidateFunctionReturnType = { Ok: string } | { Err: string };
export type WithdrawRefundReceipt = { Ok: boolean } | { Err: string };
...
export interface _SERVICE {
  ...
  addTokenToBlocklistValidate: ActorMethod<[Principal, TokenBlockType], ValidateFunctionReturnType>;
  addTokenValidate: ActorMethod<[Principal, string], ValidateFunctionReturnType>;
  ...
  getSupportedTokenListByName: ActorMethod<[string, bigint, bigint], [Array<TokenInfoExt>, bigint]>;
  getSupportedTokenListSome: ActorMethod<[bigint, bigint], [Array<TokenInfoExt>, bigint]>;
